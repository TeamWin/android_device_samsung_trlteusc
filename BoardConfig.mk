...
TARGET_BOOTLOADER_BOARD_NAME := trlteusc
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02600000 --dt device/samsung/trlteusc/dtb --tags_offset 0x02400000
...
#TARGET_PREBUILT_KERNEL := device/samsung/trlteusc/kernAl
...
#BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/trlteusc/custombootimg.mk
